...
Mio 作为一个语音交互入口，利用 Qwen / DeepSeek 等大模型的 AI 能力，通过 MCP 协议实现多端控制。
...
这个仓库是在原始项目基础上独立维护的开发分支，当前重点放在 ES8311 音频硬件、流媒体播放能力以及板级定制上。
...
- [自定义开发板指南](docs/custom-board.md) - 学习如何为 Mio 创建自定义开发板
...
模型服务、通信方式和设备行为请按你自己的后端部署方案进行配置。
